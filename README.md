# How to implement grasp planning improvements
## Grasp net tuning
We increased the number of grasps generated by graspnet, this required parameter tuning of graspnet initiation.

Modifications:
"OCRTOC_DesignProject_mpsys/ocrtoc_perception/src/ocrtoc_perception/perceptor.py" Perceptor constructor now have additional parameters sent to graspnet initiation.

## Grasp pose filters
For graspfiltering, we have 4 new functions, all located in "OCRTOC_DesignProject_mpsys/ocrtoc_perception/src/ocrtoc_perception/perceptor.py" and called in the modified function "assign_grasp_pose".

New functions in file:
- assign_grasps_to_object
- center_of_mass_score
- pointsInCollisionBox
- filterPoses

Modified function in file:
- assign_grasp_pose
